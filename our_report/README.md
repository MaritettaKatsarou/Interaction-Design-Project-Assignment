...
# Introduction
Έξυπνο πορτάκι για μικρόσωμα κατοικίδια που θα επιτρέπει την ελεγχόμενη είσοδο σε συγκεκριμένα ζώα με βάση την ηλεκτρονική τους ταυτότητα. 

# Summary 
Έξυπνο πορτάκι που ενσωματώνεται σε ήδη υπάρχουσες πόρτες για μικρόσωμα κατοικίδια που θα επιτρέπει την ελεγχόμενη είσοδο σε συγκεκριμένα ζώα με βάση την ηλεκτρονική τους ταυτότητα.
Θα αποθηκεύει στη μνήμη του μέχρι 5 ηλεκτρονικές ταυτότητες και θα ξεκλειδώνει το πορτάκι όταν κάποιο απο αυτά βρίσκεται σε απόσταση 30cm.
...
2] Έρευνα και προμήθεια υλικών απο το [GRobotronics](https://grobotronics.com/)
...
:bookmark: Ξύλο Μπάλσα (πορτάκι στο πίσω μέρος)

:bookmark: Ξύλο πεύκου και κόντρα-πλακέ σιμήδας 4mm (main part)
...
# Λοιπά έξοδα & Συνολικό Κόστος πρωτότυπου: 78€ :euro:
...
Εχοντας ολοκληρώσει την εργασία έχουμε εξοικειωθεί σε πολλά πεδία όπως στο να κάνουμε έρευνα, στον προγραμματισμό,  στην υλική κατασκευή αντικειμένων και στην κατασκευή κυκλωμάτων με Arduino που ήταν κάτι εντελώς καινούριο για εμας. Με λίγα λόγια βελτιωθήκαμε στο να σχεδιάζουμε αντικείμενα και μάθαμε να υλοποιούμε interactive αντικείμενα. Το γεγονός οτι το θέμα της εργασίας έχει έναν αρκετά μεγάλο βαθμό ελευθερίας ήταν εξαιρετικά καλό επειδή μπορέσαμε να φέρουμε την εργασία κοντά στα δικά μας ενδιαφέροντα με αποτέλεσμα να περάσουμε πολύ καλά κατα την υλοποίηση της. 

Όσο αναφορά τα προβλήματα και τις δυσκολίες που αντιμετωπίσαμε κατα τη διάρκεια της υλοποίησης του project, πρέπει να αναφέρουμε ότι η έλλειψη εργαστηριακού εξοπλισμού και εργαλείων για την κατασκευή του πρωτότυπου, που δεν μας παρέχει η σχολή, μας δυσκόλεψαν πολύ στην όλη προσπάθεια της κατασκευής. Επίσης η εύρεση υλικών στο νησί ήταν και αυτό ένα δύσκολο κομμάτι και πολλές φορές τα εξαρτήματα που αναγκαζομασταν να παραγγείλουμε από την Αθήνα, έκαναν αρκετές μέρες να έρθουν.
...
:boy: Χαράλαμπος Αλιφιέρης (Γενική Βοήθεια)


# Sources

### :pushpin: RFID and I2C LCD
...
### :pushpin: Control Stepper Motor with DRV8825 Driver
